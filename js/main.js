...
$('input[type=radio][name=tipoPessoa]').change(function () {
 ...
 // Adiciona um evento de clique para cada link do pet
 petLinks.forEach(link => {
    link.addEventListener('click', function(event) {
        // Evita que o link seja seguido
        event.preventDefault();

        // Obtém o ID do pet clicado
        const petId = this.getAttribute('data-pet-id');

        // Atualiza o conteúdo do modal com as informações do pet clicado
        // Aqui você pode adicionar código JavaScript para preencher o modal com as informações do pet
        // Por enquanto, apenas um exemplo de console.log para verificar se o ID do pet está sendo capturado corretamente
